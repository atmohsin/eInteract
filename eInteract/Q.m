...
NSString *const SELECT_ASSESS_TEST = @"select c.name,at.questions,at.duration,at.testid from assess_test at,course c where at.courseid = c.courseid and at.courseid=?";
NSString *const SELECT_TEST_QUEST = @"SELECT qid,name name FROM assess_quest where testid =1";
